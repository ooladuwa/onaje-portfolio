  ...
  return (
    <section id="myTech">
      <div className="container flex flex-col items-center bg-cloud py-4 tablet:py-8 laptop:py-12 min-w-full">
        <div className="container rounded-full shadow-2xl flex flex-col items-center bg-light-grey py-4 tablet:py-8 laptop:py-12 min-w-3/6">
          <div className="flex flex-col items-center">
            <h2 className="text-blue-minded text-2xl tablet:text-3xl laptop:text-4xl mb-6">
              My Tech
            </h2>
