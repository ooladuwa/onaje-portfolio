...
const Projects = () => {
  return (
    <section id="projects">
      <div className="bg-goldenrod-yellow flex flex-col items-center p-4 tablet:p-8 min-w-full">
        ...
        >
          ...
          <div className="flex flex-col m-4 tablet:m-8 laptop:mt-0 laptop:w-11/12">
            ...
            <p className="text-golden-poppy my-2 tablet:my-4 tablet:text-xl laptop:text-2xl">
              Web
            </p>
        ...
        >
          ...
          <div className="flex flex-col m-4 tablet:m-8  laptop:mt-0 laptop:w-11/12">
            ...
            <p className="tablet:text-xl tablet:my-2 laptop:text-2xl laptop:my-4">
              ...
              designed to provide a safe space to store, access, and contribute
              to the recipes that define communities. Users are able to create
        ...
        >
          ...
          <div className="flex flex-col m-4 tablet:m-8  laptop:mt-0 laptop:w-11/12 laptop:text-3xl">
            ...
            <p className="tablet:text-xl tablet:my-2 laptop:text-2xl laptop:my-4">
              Secret Family Recipes FE is a React app designed to provide a safe
              space to store, access, and contribute to the recipes that define
              communities. Users are able to create an account, login/logout,
              and create, store, edit, delete, and search recipes.
            </p>
            <div className="flex text-irish-green mt-2">
              <a
                className="btn-project rounded-full py-2 px-4 tablet:text-lg mr-4 tablet:mr-8 laptop:mr-10"
